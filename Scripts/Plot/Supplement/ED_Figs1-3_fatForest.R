...
# ====================================
png("/Users/Battrd/Documents/School&Work/WiscResearch/FatTails/Figures/Supplement/ED_Fig1_zoop_Marginal.png", res=150, units="in", height=5, width=3.5)
...
plot(zoop.pp.N, type="l", xlab=bquote(Time~series~length),ylab=bquote(Zooplankton~~xi))
# text.corner("B")
dev.off()
...
# ====================================
# dev.new(width=3.5, height=5)
png("/Users/Battrd/Documents/School&Work/WiscResearch/FatTails/Figures/Supplement/ED_Fig2_fish_Marginal.png", res=150, units="in", height=5, width=3.5)
...
plot(fish.pp.lambda, type="l", xlab=bquote(abs(abs(lambda))),ylab=bquote(Fish~~xi))
...
# =========================================
# dev.new(width=3.5, height=5)
png("/Users/Battrd/Documents/School&Work/WiscResearch/FatTails/Figures/Supplement/ED_Fig3_fullData_Marginal.png", res=150, units="in", height=5, width=3.5)
