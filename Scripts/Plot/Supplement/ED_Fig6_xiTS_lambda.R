...
# png("/Users/Battrd/Documents/School&Work/WiscResearch/FatTails/Figures/Supplement/FigS3_xiTS_lambda.png", res=150, units="in", height=3.5, width=3.5)
pdf("/Users/Battrd/Documents/School&Work/WiscResearch/FatTails/Figures/Supplement/FigS3_xiTS_lambda.pdf", width=3.42, height=3.42)
# dev.new(height=3.5, width=3.5)
dscat(z[,"lambda"], z[,"xi2"], mar=c(2.5,2.5,0,0), cex=1, ps=8, family="Times", mgp=c(3, 0.5, 0), tcl=-0.35)
