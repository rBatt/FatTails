...
myFatSim <- function(x){
	...
	adf <- data.frame(x, "Order"=Order, "Lambda"=Lambda, "minRoot"=minRoot, t(arC2), t(maC2), "Xi"=Xi)
...
simXi0 <- dlply(.data=simPars, .variables=c("P","Q","Distribution","SD", "Rep"), .fun=myFatSim)
