...
png("FatFigures/periodHistogram.png", width=3.4, height=3.4, units="in", res=300, bg=myWhite)
...
# }
# dev.new(width=3.4, height=3.4)
png("FatFigures/orderBar.png", width=3.4, height=3.4, units="in", res=300, bg=myWhite)
...
png("FatFigures/lambda_order_N.png", width=3.4, height=3.4, units="in", res=300, bg=myWhite)
...
png("FatFigures/lambda_variance_hist.png", width=6, height=3.4, units="in", res=300, bg=myWhite)
...
#Figure 2
# dev.new(width=6, height=3.4)
png("FatFigures/variance_lambda.png", width=6, height=3.4, units="in", res=300, bg=myWhite)
library("gridExtra")
library("ggplot2")
...
# dev.new(width=3.4, height=3.4)
png("FatFigures/Xi_InfE.png", width=3.4, height=3.4, units="in", res=300, bg=myWhite)
...
# dev.new(width=3.4, height=3.4)
png("FatFigures/Xi_Lambda.png", width=3.4, height=3.4, units="in", res=300, bg=myWhite)
...
# ==========================
png("FatFigures/Box_ReturnShape.png", width=7, height=3.4, units="in", res=300, bg=myWhite)
...
# ==================================================================
png("FatFigures/ScatterReturns.png", width=6, height=2, bg=myWhite, units="in", res=300)
...
# ========================
png("FatFigures/ScatterReturns_2blank.png", width=6, height=2, bg=myWhite, units="in", res=300)
...
# ========================
png("FatFigures/ScatterReturns_allBlank.png", width=6, height=2, bg=myWhite, units="in", res=300)
...
png("FatFigures/Returns.png", width=7, height=3.4, units="in", res=300, bg=myWhite)
...
png("FatFigures/Returns_1.png", width=3.4, height=3.4, units="in", res=300, bg=myWhite)
...
png("FatFigures/fatTimeSeries.png", width=5, height=7, bg=myWhite, units="in", res=300)
