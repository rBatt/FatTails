...
# _v2 (12-Mar-2014): Include analysis of stable distribution (to replace return times of ARMA residuals), and trim figures down to those relevant for paper. Currently several presentation-style figures exist, as well as ancillary figures that will mostl likely not be included in the paper.
...
load("final_fatARMA_Summary_v6.RData")
