...
png("FatFigures_v2/Xi_sigInf.png", width=3.4, height=3.4, units="in", res=300, bg=myWhite)
...
png("FatFigures_v2/Xi_eInf.png", width=3.4, height=3.4, units="in", res=300, bg=myWhite)
...
png("FatFigures_v2/Corrected_sigma_InfE_justAR1.png", width=3.4, height=6, units="in", res=300, bg=myWhite)
