...
\[{{X}_{T}}\left( t+\Delta t \right)=B\left( \varphi_T \left( t \right),{{X}_{T}} \right)S\left( \gamma_T \left( t \right),{{X}_{T}} \right){{X}_{T}}\left( t \right)\]

% Heuristic Population, in-text term 1
\[B\left( \varphi_T \left( t \right),{{X}_{T}} \right)\]

%  Heuristic Population, in-text term 2
\[S\left( \gamma_T \left( t \right),{{X}_{T}} \right)\]

% Heuristic Population Eq2
\[{{X}_{T+1}}={{X}_{T}}\prod\limits_{i=1}^{1/\Delta t}{B\left( \varphi_T \left( i\Delta t \right),{{X}_{T}} \right)S\left( \gamma_T \left( i\Delta t \right),{{X}_{T}} \right)}\]

% Heuristic Population Eq3
\[\begin{array}{*{35}{l}}
   {{x}_{T+1}} & ={{x}_{T}}+\sum\limits_{i=1}^{1/\Delta t}{\left\{ b\left( \varphi_T \left( i\Delta t \right),{{x}_{T}} \right)+s\left( \gamma_T \left( i\Delta t \right),{{x}_{T}} \right) \right\}}  \\
