...
source("FatTails_Functions_v8.R") #the logStat function in tonyARMA_short needs the Inf2NA function
...
# =============================================================
if(runStable){
	source("stableTime_v0.R")
}else{
	load("stableTime_v0.RData")
}
...
save(final, file="final_fatARMA_Summary_v6.RData")
