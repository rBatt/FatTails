...
plot((1:(n.per.sample * samples.per.year))/n.per.sample, annual.variables[,3], type='l', col='green', xlab='Time t within a year', ylab='Standardized value', ylim=c(0,3))
...
points(samples.per.year*(1:length(Y) - 1/2),Y)

gev.fit2(xdat=Y, show = FALSE, method = "Nelder-Mead", maxit = 10000)$mle[3]
